...
@qiime.method
@method.parameter('sequences', DemultiplexedSequences, help='')
...
@method.parameter('phred_quality_threshold', Range(Integer, 0, None),
    help='the maximum unacceptable Phred quality score (e.g., '
    'for Q20 and better, specify -q 19)', default=3)
@method.result('result', QualityFilterResult, help='')
def quality_filter_sequences(sequences, ...):
